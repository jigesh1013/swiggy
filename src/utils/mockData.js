const resObj = {
  ...
  data: {
    name: "Meghana Foods",
    cuisines: ["Biryani, North Indian, Asian, American, Fast Food"],
  },
};
...
export const restaurantList1 = [
  {
    ...
    data: {
      ...
      menu: [
        ...
        {
          name: "Paneer Gravy pizza",
          cost: 180,
        },
        {
          name: "Paprika Grill pizza",
          cost: 210,
        },
        {
          name: "Special pizza",
  ...
  },
  {
    ...
    data: {
      ...
      menu: [
        ...
        {
          name: "Fry Goat with mushroom gravy",
          cost: 310,
        },
        {
